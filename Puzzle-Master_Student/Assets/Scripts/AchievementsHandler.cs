...
public class AchievementsHandler : MonoBehaviour
{
    ...
    internal static void UnlockByModelId(string id, int pieceCount)
    {
        if (id == "811")
        {
            UnlockAchievement(Achievement.Akuma1);
            SetProgressStat(Stat.AKUMA, pieceCount, true);
        }
        else if (id == "812")
        {
            UnlockAchievement(Achievement.Akuma2);
            SetProgressStat(Stat.AKUMA, pieceCount, false);
        }
        else if (id == "813")
        {
            UnlockAchievement(Achievement.Mariko1);
            SetProgressStat(Stat.MARIKO, pieceCount, true);
        }
        else if (id == "814")
        {
            UnlockAchievement(Achievement.Mariko2);
            SetProgressStat(Stat.MARIKO, pieceCount, false);
        }
        else if (id == "815")
        {
            UnlockAchievement(Achievement.Pam1);
            SetProgressStat(Stat.PAM, pieceCount, true);
        }
        else if (id == "816")
        {
            UnlockAchievement(Achievement.Pam2);
            SetProgressStat(Stat.PAM, pieceCount, false);
        }
        else if (id == "817")
        {
            UnlockAchievement(Achievement.Rudi1);
            SetProgressStat(Stat.RUDI, pieceCount, true);
        }
        else if (id == "818")
        {
            UnlockAchievement(Achievement.Rudi2);
            SetProgressStat(Stat.RUDI, pieceCount, false);
        }
        else if (id == "819")
        {
            UnlockAchievement(Achievement.Xoxo1);
            SetProgressStat(Stat.XOXO, pieceCount, true);
        }
        else if (id == "820")
        {
            UnlockAchievement(Achievement.Xoxo2);
            SetProgressStat(Stat.XOXO, pieceCount, false);
        }
        else if (id == "821")
        {
            UnlockAchievement(Achievement.Yoko1);
            SetProgressStat(Stat.YOKO, pieceCount, true);
        }
        else if (id == "822")
        {
            UnlockAchievement(Achievement.Yoko2);
            SetProgressStat(Stat.YOKO, pieceCount, false);
        }
    ...
    static readonly Dictionary<Achievement, string> AchievementsSteamIDs = new Dictionary<Achievement, string>()
    {
        ...
        { Achievement.Yoko1,                                "NEW_ACHIEVEMENT_1_1"},
        { Achievement.Yoko2,                                "NEW_ACHIEVEMENT_1_2"},
        { Achievement.Mariko1,                              "NEW_ACHIEVEMENT_1_3"},
        { Achievement.Mariko2,                              "NEW_ACHIEVEMENT_1_4"},
        { Achievement.Pam1,                                 "NEW_ACHIEVEMENT_1_5"},
        { Achievement.Pam2,                                 "NEW_ACHIEVEMENT_1_6"},
        { Achievement.Rudi1,                                "NEW_ACHIEVEMENT_1_7"},
        { Achievement.Rudi2,                                "NEW_ACHIEVEMENT_1_8"},
        { Achievement.Xoxo1,                                "NEW_ACHIEVEMENT_1_9"},
        { Achievement.Xoxo2,                                "NEW_ACHIEVEMENT_1_10"},
        { Achievement.Akuma1,                               "NEW_ACHIEVEMENT_1_11"},
        { Achievement.Akuma2,                               "NEW_ACHIEVEMENT_1_12"},
